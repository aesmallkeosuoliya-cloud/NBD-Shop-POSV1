    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <Card>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
          ...
          <Input label={t('branch')} value={t('all')} disabled wrapperClassName="mb-0" />
        ...
        <>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-100">
                  <tr>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">{t('branch')}</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {supplierSummaries.map(summary => (
                    ...
                    >
                      <td className="px-4 py-3 whitespace-nowrap">{t('all')}</td>
                 ...
                 <tfoot className="bg-gray-200 font-bold text-gray-800">
                    <tr>
                        <td colSpan={3} className="px-4 py-3 text-right">{t('grandTotalOutstanding')}:</td>
          ...
          {selectedSupplierDetails && (
            <Card 
              ...
              bodyClassName="p-0"
              titleActions={<Button variant="danger" size="sm" onClick={() => setSelectedSupplierId(null)}>{t('close')}</Button>}
            >
               <div className="overflow-x-auto">
